...
| `REACT_APP_HOMESERVER`                 | If set, it uses this homeserver instead of showing an input field on the login screen. Either a domain name to discover matrix client configuration and get homeserver URL or homeserver URL.  | `example.com`                   |
| `REACT_APP_SKIP_LOGIN`                 | If set and `REACT_APP_HOMESERVER` is set, it skips welcome/login screens and redirects to SSO                                                                                                  | `true`                          |
| `REACT_APP_LOGOUT_REDIRECT_URL`        | If set, it redirects user to specified URL after logout                                                                                                                                        | `https://id.example.com/logout` |
