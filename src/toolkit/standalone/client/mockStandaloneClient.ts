...
export function mockStandaloneClient(): MockedStandaloneClient {
  return {
    ...
    getRoomLastViewed: vi.fn().mockResolvedValue({}),
    markRoomViewed: vi.fn().mockResolvedValue(undefined),
    roomLastViewedObservable: vi.fn().mockReturnValue(new Observable()),
